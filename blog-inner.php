...
<body style="">
  ...
  <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasCart" aria-labelledby="My Cart">
    ...
    <div class="hero-content position-absolute d-flex justify-content-center align-items-center text-center">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="page-title text-light  " data-aos="fade-up">Blog</h1>
 ...
 <section class="post-wrap py-lg-7">
  <div class="container">
    <div class="row">
        ...
        <div class="row">
          <article class="post-item">
            <div class="hero-image mb-5">
              <img src="images/post-large-image.jpg" alt="single-post" class="img-fluid">
            </div>

            <div class="post-content">
              <div class="post-meta" data-aos="fade-up">
                <span class="post-category">Ceylon Cinnamon</span> / <span class="meta-date">12 July, 2023</span>
              </div>

              <h2 class="fs-1 text-capitalize" data-aos="fade-up">The Essence of True Ceylon Cinnamon</h2>

              <div class="post-description" data-aos="fade-up">
                <p>
                  True Ceylon cinnamon has long been treasured for its delicate aroma, refined sweetness, and natural purity. Native to Sri Lanka, this exceptional spice carries centuries of heritage, cultivated with care and respect for nature. At Ceyluxe Co., cinnamon is more than an ingredient—it is a reflection of tradition, quality, and authenticity.
                </p>

                <p>
                  Unlike common varieties found elsewhere, Ceylon cinnamon is known for its light texture, subtle flavor, and wellness-friendly properties. Carefully hand-harvested and peeled by skilled artisans, each quill preserves the natural oils that define its distinctive character and global reputation.
                </p>

                <blockquote>
                  “True Ceylon cinnamon is not defined by strength alone, but by balance—of aroma, flavor, and purity.”
                </blockquote>

                <h4 class="fs-5">Rooted in Heritage, Guided by Science</h4>
                <ul class="inner-list">
                  <li>Exclusively sourced from Sri Lanka’s traditional cinnamon-growing regions.</li>
                  <li>Hand-peeled using time-honored techniques passed through generations.</li>
                  <li>Produced under ISO 22000, GMP, and HACCP quality standards.</li>
                </ul>

                <p>
                  At Ceyluxe Co., quality is ensured at every stage—from cultivation and processing to packaging and distribution. Our facilities operate in compliance with internationally recognized food safety and quality systems, ensuring consistency, traceability, and consumer trust.
                </p>

                <p>
                  Beyond flavor, true Ceylon cinnamon is valued for its scientifically recognized wellness benefits. It is widely appreciated for supporting daily health while offering a gentle, naturally balanced alternative to stronger spice varieties.
                </p>

                <!-- <img src="images/post-item2.jpg" alt="post-image" class="img-fluid float-start pe-3 mb-3"> -->

                <p>
                  Thoughtful packaging inspired by Sri Lankan traditional arts completes the journey—presenting a product that honors its origins while meeting modern global expectations. Every detail reflects our commitment to excellence and authenticity.
                </p>

                <p>
                  What began as family-based cultivation has grown into a structured venture through Ceyluxeco Exports (Pvt) Ltd, enabling us to share Sri Lanka’s finest spices with both local and international markets while staying true to our roots.
                </p>

                <p>
                  Today, Ceyluxe Co. proudly delivers premium Ceylon cinnamon crafted with integrity, inspired by tradition, and defined by uncompromising quality—bringing the true taste of Sri Lanka to the world.
                </p>

                <div class="post-bottom-link d-flex justify-content-between mt-5">
                  <div class="block-tag">
                    <ul class="list-unstyled d-flex flex-wrap text-capitalize">
                      <li class="pe-3">
                        <a href="#" class="text-primary">Tags:</a>
                      </li>
                      <li class="pe-3">
                        <a href="#" class="text-primary">Ceylon cinnamon,</a>
                      </li>
                      <li class="pe-3">
                        <a href="#" class="text-primary">Sri Lankan spices,</a>
                      </li>
                      <li class="pe-3">
                        <a href="#" class="text-primary">Wellness,</a>
                      </li>
                      <li class="pe-3">
                        <a href="#" class="text-primary">Authentic origin</a>
                      </li>
                    </ul>
                  </div>
                </div>
  ...
  <div class="row">
    <div class="post-content position-absolute top-50 start-50 translate-middle d-flex justify-content-center align-items-center">
      <div class="display-header text-center text-light">
        <h2 class="display-6 m-0 text-light mb-3 " data-aos="fade-up">Discover the Story Behind True Ceylon Cinnamon</h2>
        <p data-aos="fade-up">Explore our heritage, craftsmanship, and commitment to authentic Sri Lankan spices.</p>
        <a href="blog.php" class="btn btn-lg btn-light mt-3" data-aos="fade-up">Read Our Journal</a>
      </div>
    </div>
  </div>
</section>
