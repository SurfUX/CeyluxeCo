  <section id="best-sells" class="py-lg-6">
    <div class="display-header text-center">
      <h2 class="display-6   m-0" data-aos="fade-up">Best Sellers</h2>
      <p data-aos="fade-up">These are the items that are best seller.</p>
    </div>
