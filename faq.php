  ...
  <div class="preloader" style="display: none;">
    ...
    <div class="hero-content position-absolute d-flex justify-content-center align-items-center text-center">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="page-title text-light  "data-aos="fade-up" >FAQ</h1>
...
<section id="faqs" class="py-lg-7">
  <div class="container">
    <div class="accordion" id="accordionExample" data-aos="fade-up">

      <div class="accordion-item border-0 border-bottom">
        <h2 class="accordion-header m-0" id="headingOne">
          <button class="accordion-button fs-4 bg-transparent px-0" type="button"
        ...
        <div id="collapseOne" class="accordion-collapse collapse show"
          ...
          <div class="accordion-body">
            You can place an order directly through our website by selecting your preferred products and completing the checkout process. For bulk or export inquiries, please contact us directly.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item border-0 border-bottom">
        <h2 class="accordion-header m-0" id="headingTwo">
          <button class="accordion-button fs-4 px-0 bg-transparent collapsed" type="button"
            data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false"
            aria-controls="collapseTwo">
            Do you sell products online only?
          </button>
        </h2>
        <div id="collapseTwo" class="accordion-collapse collapse"
          aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
          <div class="accordion-body">
            Our products are primarily available online. However, for wholesale, export, or special requests, you may contact us directly.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item border-0 border-bottom">
        ...
        <div id="collapseThree" class="accordion-collapse collapse"
          ...
          <div class="accordion-body">
            Yes. We occasionally offer promotions and special pricing. Subscribe to our newsletter or follow us on social media to stay updated.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item border-0 border-bottom">
        ...
        <div id="collapseFour" class="accordion-collapse collapse"
          ...
          <div class="accordion-body">
            You will need to provide your name, contact details, delivery address, and payment information to complete an order successfully.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item border-0 border-bottom">
        ...
        <div id="collapseFive" class="accordion-collapse collapse"
          ...
          <div class="accordion-body">
            Orders can be canceled or modified before they are processed for shipping. Please contact our support team as soon as possible for assistance.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item border-0 border-bottom">
        ...
        <div id="collapseSix" class="accordion-collapse collapse"
          ...
          <div class="accordion-body">
            If you receive a damaged or incorrect item, please contact us within the specified period. Our team will assist you with a replacement or refund in accordance with our return policy.
          </div>
        </div>
      </div>
  ...
  <div class="row">
    <div class="post-content position-absolute top-50 start-50 translate-middle d-flex justify-content-center align-items-center">
      <div class="display-header text-center text-light">
        <h2 class="display-6 m-0 text-light mb-3" data-aos="fade-up">From Sri Lanka to the World</h2>
        <p data-aos="fade-up">Experience the purity, heritage, and craftsmanship behind true Ceylon cinnamon.</p>
        <a href="blog.html" class="btn btn-lg btn-light mt-3" data-aos="fade-up">Explore More</a>
      </div>
    </div>
  </div>
</section>
