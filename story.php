...
<section class="hero-section position-relative background-about">
  <div class="hero-content position-absolute d-flex justify-content-center align-items-center text-center">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="page-title text-light" data-aos="fade-up">Ceylon Cinnamon – The True Wonder Spice</h1>
          <div class="breadcrumbs text-light" data-aos="fade-up">
            <span class="item">
              <a href="index.html" class="text-light">Home /</a>
            </span>
            <span class="item">About Ceylon Cinnamon</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-7">
        <div class="detail-entry ">
          ...
          <ul data-aos="fade-left">
            ...
            <li>Genus: Cinnamomum</li>
            <li>Country of origin- Sri Lanka</li>
            <li>Common names: Ceylon cinnamon, true cinnamon, Sri Lanka cinnamon</li>
          </ul>
        </div>
      </div>
    </div>
         ...
         <h3 class="mt-0 mb-4 fs-2" data-aos="fade-right"> A Spice That Once Held Greater Value Than Silver or Gold</h3> 
          <p data-aos="fade-right">
           Ceylon cinnamon has been cherished for thousands of years, with records of its use dating
            ...
            silver, or gemstones. Even King Solomon (circa 970–931 BC) counted cinnamon among his
  ...
  <div class="container-lg">
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 text-center mb-4 mb-lg-0">
        <div class="icon-box" data-aos="fade-right">
          <div class="icon-box-content">
            <h3 class="fs-3 feature-title mt-0 mb-3">Rare & Authentic</h3>
            <p>Grown exclusively in Sri Lanka, representing less than 0.5% of global cinnamon supply.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6 text-center mb-4 mb-lg-0">
        <div class="icon-box" data-aos="fade-right">
          <div class="icon-box-content">
            <h3 class="fs-3 feature-title mt-0 mb-3">Handcrafted</h3>
            <p>Manually peeled and quilled by skilled artisans using centuries-old techniques.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6 text-center mb-4 mb-lg-0">
        <div class="icon-box" data-aos="fade-left">
          <div class="icon-box-content">
            <h3 class="fs-3 feature-title mt-0 mb-3">Health Focused</h3>
            <p>Low coumarin content makes it safe for regular consumption.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6 text-center mb-4 mb-lg-0">
        <div class="icon-box" data-aos="fade-left">
          <div class="icon-box-content">
            <h3 class="fs-3 feature-title mt-0 mb-3">Globally Valued</h3>
            <p>Once more valuable than gold, now prized for wellness and culinary excellence.</p>
          </div>
        </div>
      </div>
...
<section id="about" class="py-lg-7">
  <div class="container-lg">
    <div class="row">
      <div class="col-lg-5">
        <div class="row">
