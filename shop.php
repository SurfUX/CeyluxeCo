          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
              <div class="product-item mx-auto" data-aos="fade-up">
                ...
                <div class="product-info text-center">
                  <h3 class="m-0">
                    <a href="single-product.php" class="text-dark">Ceylon Cinnamon Quills</a>
                  </h3>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
              <div class="product-item mx-auto" data-aos="fade-up">
                ...
                <div class="product-info text-center">
                  <h3 class="m-0">
                    <a href="single-product.php" class="text-dark">Premium Cinnamon Sticks</a>
                  </h3>
            ...
            <!-- Product 3 -->
             <div class="col-lg-3 col-md-6 mb-5">
              <div class="product-item mx-auto" data-aos="fade-up">
                ...
                <div class="product-info text-center">
                  <h3 class="m-0">
                    <a href="single-product.php" class="text-dark">Ground Ceylon Cinnamon</a>
                  </h3>
