  ...
  <section class="hero-section position-relative background-about" style="">
    <div class="hero-content position-absolute d-flex justify-content-center align-items-center text-center">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="page-title text-light  ">Contact Us</h1>
...
<section class="contact-us-wrap py-lg-7">
  <div class="container-lg">
    <div class="row flex-row-reverse">
        ...
        <form id="contactForm" action="contact.php" method="post" class="form-group contact-form mt-4"  data-aos="fade-left">
          <div class="form-input col-lg-12 d-flex justify-content-between mb-3">
            <div class="w-100 me-3">
              ...
              <input type="text" name="name" placeholder="Enter your full name" class="form-control shadow-none px-3 py-2" required>
            </div>
            <div class="w-100">
              <label class="mb-2 fs-6 text-dark">Your E-mail*</label>
              <input type="email" name="email" placeholder="Enter your email address" class="form-control shadow-none px-3 py-2" required>
            </div>
          </div>

          <div class="col-lg-12 mb-3">
            <label class="mb-2 fs-6 text-dark">Phone Number</label>
            <input type="number" name="phone" placeholder="Optional" class="form-control shadow-none px-3 py-2">
          </div>

          <div class="col-lg-12 mb-3">
            <label class="mb-2 fs-6 text-dark">Subject</label>
            <input type="text" name="subject" placeholder="Product inquiry, partnership, export, etc." class="form-control shadow-none px-3 py-2">
          </div>
          ...
          <div class="d-grid">
            <button type="submit" name="submit" class="btn btn-lg btn-dark fs-6">Send Message</button>
          </div>
        </form>
      </div>
      ...
      <div class="contact-info col-lg-6 mb-5">
        <h2 class="fs-2 mb-4" data-aos="fade-right">Contact Information</h2>
        <p data-aos="fade-right">Reach out to us for product details, wholesale inquiries, or international collaborations.</p>

        <div class="page-content">

          <div class="col-md-6">
            <div class="content-box my-5" data-aos="fade-right">
              <h5 class="element-title" data-aos="fade-right">Head Office</h5>
              <div class="contact-address" data-aos="fade-right">
                <p>Sri Lanka, Ceyluxeco Exports (Pvt) Ltd</p>
              </div>
              <div class="contact-number" data-aos="fade-right">
          ...
          <div class="col-md-6">
            <div class="content-box my-5" data-aos="fade-right">
              <h5 class="element-title">Exports & Partnerships</h5>
          ...
          <div class="col-md-6">
            <div class="content-box my-5">
              <h5 class="element-title" data-aos="fade-right">Connect With Us</h5>
              <div class="social-links" data-aos="fade-right">
                <ul class="social-links d-flex flex-wrap list-unstyled mt-3">
                  <li class="social me-4">
                    <a href="https://web.facebook.com/people/Ceyluxe-Co/61568377871811/?mibextid=wwXIfr&rdid=s0cxGRJT06LpSkCd&share_url=https%3A%2F%2Fweb.facebook.com%2Fshare%2F1APRTBgCWF%2F%3Fmibextid%3DwwXIfr%26_rdc%3D1%26_rdr"><svg width="20" height="20"><use xlink:href="#facebook"></use></svg></a>
                  </li>
                  <!-- <li class="social me-4">
                    <a href="#"><svg width="20" height="20"><use xlink:href="#twitter"></use></svg></a>
                  </li> -->
                  <li class="social me-4">
                    <a href="https://www.linkedin.com/company/ceyluxeco-exports-pvt-ltd/"><svg width="20" height="20"><use xlink:href="#linkedin"></use></svg></a>
                  </li>
                  <li class="social me-4">
                    <a href="https://www.instagram.com/ceyluxe_co?igsh=MWg4cjlkMHlycG5zNw=="><svg width="20" height="20"><use xlink:href="#instagram"></use></svg></a>
                  </li>
                  <li class="social me-4">
                    <a href="#"><svg width="20" height="20"><use xlink:href="#youtube"></use></svg></a>
                  </li>
                </ul>
              </div>
            </div>
  ...
  <div class="row">
    <div class="post-content position-absolute top-50 start-50 translate-middle d-flex justify-content-center align-items-center">
      <div class="display-header text-center text-light">
        <h2 class="display-6 m-0 text-light mb-3" data-aos="fade-up">Experience True Ceylon Cinnamon</h2>
        <p data-aos="fade-up">Discover the heritage, craftsmanship, and purity behind Sri Lanka’s finest spices.</p>
        <a href="blog.html" class="btn btn-lg btn-light mt-3" data-aos="fade-up">Explore Our Story</a>
      </div>
    </div>
  </div>
</section>
