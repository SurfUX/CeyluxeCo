...
<section class="post-grid py-lg-8">
  <div class="container-lg">
    <div class="row">

      <article class="post-item mb-5" data-aos="fade-up">
        <div class="row align-items-center">
          <div class="col-lg-4 col-md-6">
            <div class="post-media1 mb-3">
          ...
          <div class="col-lg-6 col-md-6">
            <div class="row">
              <div class="post-meta" >
                <span class="meta-date">12-Dec-2023</span>
                <div class="post-info-category">
                  <a href="#" rel="category">Ceylon Cinnamon</a>, <a href="#" rel="category">Heritage</a>
                </div>
              </div>
              <div class="post-content">
                <h2 class="fs-2 my-1 text-capitalize">
                  <a href="blog-inner.php">The Legacy of True Ceylon Cinnamon</a>
                </h2>
                <p>
                  Explore the centuries-old heritage of Sri Lanka’s finest cinnamon and how traditional cultivation preserves its unmatched aroma and purity.
                </p>
                <a href="blog-inner.php" class="btn btn-dark btn-medium">Read More</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <article class="post-item mb-5" data-aos="fade-up">
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 col-md-6">
            <div class="row">
              <div class="post-meta">
                <span class="meta-date">11-July-2023</span>
                <div class="post-info-category">
                  <a href="#" rel="category">Wellness</a>, <a href="#" rel="category">Natural</a>
                </div>
              </div>
              <div class="post-content">
                <h2 class="fs-2 my-1 text-capitalize">
                  <a href="blog-inner.php">A Natural Healer for Body and Mind</a>
                </h2>
                <p>
                  Discover how true Ceylon cinnamon supports wellness through its natural properties, trusted for generations around the world.
                </p>
                <a href="blog-inner.php" class="btn btn-dark btn-medium">Read More</a>
              </div>
            </div>
      ...
      <article class="post-item mb-5" data-aos="fade-up">
        <div class="row align-items-center">
          <div class="col-lg-4 col-md-6">
            <div class="post-media1 mb-3">
              <img src="images/post-item4.webp" alt="post" class="img-fluid">
            </div>
          </div>
          <div class="col-lg-6 col-md-6">
            <div class="row">
              <div class="post-meta">
                <span class="meta-date">11-July-2023</span>
                <div class="post-info-category">
                  <a href="#" rel="category">Quality</a>, <a href="#" rel="category">Health</a>
                </div>
              </div>
              <div class="post-content">
                <h2 class="fs-2 my-1 text-capitalize">
                  <a href="blog-inner.php">Why Quality Matters in Cinnamon</a>
                </h2>
                <p>
                  Learn what makes premium Ceylon cinnamon different—from ethical sourcing to scientific quality standards.
                </p>
                <a href="blog-inner.php" class="btn btn-dark btn-medium">Read More</a>
              </div>
            </div>
      ...
      <article class="post-item mb-5" data-aos="fade-up">
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 col-md-6">
            <div class="row">
              <div class="post-meta">
                <span class="meta-date">12-July-2023</span>
                <div class="post-info-category">
                  <a href="#" rel="category">Learn</a>, <a href="#" rel="category">Cinnamon</a>
                </div>
              </div>
              <div class="post-content">
                <h2 class="fs-2 my-1 text-capitalize">
                  <a href="blog-inner.php">How to Identify True Ceylon Cinnamon</a>
                </h2>
                <p>
                  A simple guide to recognizing authentic Ceylon cinnamon and understanding why origin and processing matter.
                </p>
                <a href="blog-inner.php" class="btn btn-dark btn-medium">Read More</a>
              </div>
            </div>
  ...
  <div class="row">
    <div class="post-content position-absolute top-50 start-50 translate-middle d-flex justify-content-center align-items-center">
      <div class="display-header text-center text-light">
        <h2 class="display-6 m-0 text-light mb-3" data-aos="fade-up">Discover the World of True Ceylon Cinnamon</h2>
        <p data-aos="fade-up">Learn about our heritage, craftsmanship, and the science behind Sri Lanka’s finest spices.</p>
        <a href="blog.php" class="btn btn-lg btn-light mt-3" data-aos="fade-up">Explore More</a>
      </div>
    </div>
  </div>
</section>
